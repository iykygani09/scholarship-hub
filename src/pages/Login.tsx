...
import { Lock, ArrowRight, GraduationCap, ArrowLeft, Eye, EyeOff, LogIn } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 bg-background flex flex-col p-8">
        ...
        <div className="max-w-md mx-auto w-full flex-1 flex flex-col justify-center">
          ...
          <button onClick={handleLogin} disabled={loading} className="gradient-cta w-full py-4 rounded-xl text-primary-foreground font-semibold text-lg flex items-center justify-center gap-2 mt-6 hover:scale-[1.02] transition-transform disabled:opacity-50">
            {loading ? (
          ...
          <p className="text-sm text-muted-foreground mt-4 text-center">
            Hint: Use <span className="font-mono text-xs text-foreground">{selectedCollege.adminEmail}</span> / <span className="font-mono text-xs text-foreground">admin123</span>
          </p>
        </div>
